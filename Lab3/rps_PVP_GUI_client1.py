...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("ece180d/test/ahh/server1", qos=1)
...
client.publish("ece180d/test/ahh/client1", '1q', qos=1)
